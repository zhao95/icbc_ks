 ...
 * 
 */
public class OutBean extends Bean {
    ...
    public OutBean setOk(String msg) {
        this.set(Constant.RTN_MSG, Constant.RTN_MSG_OK + Language.trans(msg));
        return this;
    }
    ...
    public OutBean setWarn(String msg) {
        this.set(Constant.RTN_MSG, Constant.RTN_MSG_WARN + Language.trans(msg));
        return this;
    }
    ...
    public OutBean setError(String msg) {
        this.set(Constant.RTN_MSG, Constant.RTN_MSG_ERROR + Language.trans(msg));
        return this;
    }
