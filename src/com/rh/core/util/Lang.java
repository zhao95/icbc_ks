...
import com.rh.core.util.lang.SingletonObject;
...
public class Lang {
    ...
    public static String getUUID() {
        ...
        if (StringUtils.isNotEmpty(uuid) && uuid.length() > 20) {
    ...
    public static String runScript(Bean context, String script) {
        ...
        for (Object key : keys) {
            if (key instanceof String) {
                ...
                sem1.put(strKey, context.get(key));
            }
        }
        ...
        String out = "";
        try {
            Object result = engine1.eval(script);
            if (result != null) {
