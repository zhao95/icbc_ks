...
public class Constant {
    ...
    /** 操作按钮平铺，流程按钮在弹出框中去处理 */
    public static final String FLAT_DIALOG = "12";
    /** 操作按钮下拉组，流程按钮在弹出框中去处理 */
    public static final String GROUP_DIALOG = "112";
    ...
    /** SESSION KEY **/
    public static final String RHUS_SESSION = "RHUS_SESSION";
}
