...
public class HttpClientUtils {
    ...
    public static HttpClient createHttpsClient(HttpParams httpParams) throws IOException {
    ...
    public static String getWebContent(String url) throws IOException {
        ...
        return getWebContent(client, url);
    }
    
    public static String getWebContent(HttpClient client, String url) throws IOException {
     ...
     * @throws IOException 异常
     */
    public static String getWebContent(HttpClient client, String url, Map<String, String> postParam, String encoding)
            throws IOException {
        
        HttpResponse response = client.execute(createHttpPost(url, postParam, encoding));
//        if (response.getStatusLine().getStatusCode() != HttpStatus.SC_OK) {
//            throw new IOException(response.getStatusLine().toString() + "  url: " + url);
//        }

        return HttpResponseUtils.getResponseContent(response, encoding);  
    }
    
	public static String getWebContent(String url, Map<String, String> postParam, String encoding) throws IOException {
		HttpClient client = createHttpClient();
		return getWebContent(client, url, postParam, encoding);
	}
