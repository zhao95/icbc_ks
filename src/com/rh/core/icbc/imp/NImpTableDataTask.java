...
public class NImpTableDataTask extends RhThreadTask {

	/** log. */
	private static Log log = LogFactory.getLog(NImpTableDataTask.class);

	private static final long serialVersionUID = -2073140092416868910L;
	 ...
	 * @param param
	 */
	public NImpTableDataTask(ParamBean param) {
	...
	public boolean execute() {
		// 设置上下文信息
		String onlineUserCode = Context.getSyConf("CC_IMPDATE_ONLINE_USER", "0000956635");
		try {
			// 设置上下文环境
		...
		if (incrementFlag) { // 增量走这里
			...
			try {
				 ...
				 */
				{
					...
					new NImpDept().addDeptDatas(finalSmtime);
				 ...
				 */
				{
					...
					new NImpUser().addUserDatas(finalSmtime);
