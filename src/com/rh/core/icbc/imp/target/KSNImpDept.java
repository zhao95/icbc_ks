...
public class KSNImpDept {
	private static Log log = LogFactory.getLog(KSNImpDept.class);
...
//		Transaction.end();
	...
	public void cleanDeptData() throws Exception {
		 ...
		 whereBean.setWhere(" AND CMPY_CODE = '" + KSNImpDept.CMPY_CODE + "' AND DEPT_CODE != '" + KSNImpDept.CMPY_CODE + "0001'");
