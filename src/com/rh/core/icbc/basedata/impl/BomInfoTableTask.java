 ...
 *
 */
public class BomInfoTableTask extends AbstractTableTask {

	
	private static final long serialVersionUID = 7030018590489847167L;

	public BomInfoTableTask(String smtime, boolean flag) {
		super(smtime, flag);
	}
