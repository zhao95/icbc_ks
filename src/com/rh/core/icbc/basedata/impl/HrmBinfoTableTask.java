...
public class HrmBinfoTableTask extends AbstractTableTask {

	private static final long serialVersionUID = -1458541455030665744L;

	public HrmBinfoTableTask(String smtime, boolean flag) {
		super(smtime, flag);
	}
