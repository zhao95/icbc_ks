...
public class HrmADTaskBAK extends AbstractTableTask {
	...
	public HrmADTaskBAK(String smtime, boolean flag) {
		super(smtime, flag);
	}
	...
	public boolean impIncData() {
		log.info("------------------ import SY_HRM_ZDSTAFFADMIN increment data begin ------------------");
