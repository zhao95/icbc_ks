...
//	}
	...
	public Bean getUserXm(Bean paramBean) throws ParseException {
		...
		String sql1="select a.*,b.bm_end from ts_xmgl a left join ts_xmgl_bmgl b on a.xm_id = b.xm_id and '"+datestr+"' between  b.BM_TZ_START AND b.BM_TZ_END order by b.bm_end desc";
