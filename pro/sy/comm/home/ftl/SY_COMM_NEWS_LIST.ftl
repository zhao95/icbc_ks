...
<div class='portal-box-title'><span class='portal-box-title-icon ${icon}'></span><span class="portal-box-title-label">${title}</span><span class="portal-box-hideBtn conHeanderTitle-expand"></span><span class="portal-box-more"><a href="javascript:var opts={'sId':'allNews','tTitle':'所有栏目','url':'/CM_NEWS.allNews.do','menuFlag':4};Tab.open(opts);"></a></span></div>
