...
//    URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    URL= window.UEDITOR_HOME_URL || FireFly.getContextPath() + "/sy/base/frame/coms/ueditor/";
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"/file/"//URL + "jsp/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,scrawlPath:"/file/"//URL+"jsp/"                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"jsp/fileUp.jsp"               //附件上传提交地址
        ,filePath:"/file/"//URL + "jsp/"                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"jsp/getRemoteImage.jsp"   //处理远程图片抓取的地址
        ,catcherPath:"/file/"//URL + "jsp/"                  //图片修正地址，同imagePath
        ...
        ,imageManagerPath:"/file/"//URL + "jsp/"                                    //图片修正地址，同imagePath
...
//        ,initialContent:Language.transStatic("config_string1") + 'ueditor!' 
