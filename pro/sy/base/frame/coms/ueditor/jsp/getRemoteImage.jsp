 ...
 /*    		String str = application.getRealPath(request.getServletPath());
  ...
  /*   			OutputStream os = new FileOutputStream(savetoFile);
    			...
    			String servId = request.getParameter("SERV_ID");
    			String dataId = request.getParameter("DATA_ID");
    			String fileCat = request.getParameter("FILE_CAT");
    			Bean fileBean = FileMgr.upload(servId, dataId, fileCat, is, "");
    		    IOUtils.closeQuietly(is);
    			outSrc[i]= fileBean.getId();
