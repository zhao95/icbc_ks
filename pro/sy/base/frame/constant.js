...
var UIConst = {
    PAGE_WID:"68%",//布局时内容宽度
    MENU_WID:"15%",//布局时左侧菜单宽度
    PAGE_MARGIN_LEFT:"15%", //内容margin-left
    PAGE_MARGIN_RIGHT:"17%", //内容margin-right
    ViewEngine: {
        VIEW_FUNC: "func",
    ...
    ACT_ADD: "add",
    ACT_SAVE: "save",
    ACT_ADD_SAVE_AND_SEND: "cmSaveAndSend_add",
    ACT_BYID: "byid",
    ...
    FITEM_ELEMENT_DOCBASIS : "25",				/* 办文依据 */
    FITEM_ELEMENT_SUGGEST_INPUT : "26",			/* suggest */
