...
$("#TS_BMSH_RULE_POST .rhGrid").find("tr").each(function(index, item) {
	if(index != 0){
		var dataId = item.id;		
...
function bindCard(){
	...
	jQuery("td [operCode='optSetBtn']").unbind("click").bind("click", function(){
		...
		var temp = {"act":UIConst.ACT_CARD_MODIFY,"sId":"TS_BMSH_RULE_POST","parHandler":_viewer,"widHeiArray":[width,height],"xyArray":[100,0]};
