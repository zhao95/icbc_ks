...
render = function() {
	...
	if(moduleArray) {
		...
		$(moduleArray).each(function (index, obj) {
		  var row =  $("<div id='TS_PVLG_ROLE_UPDATE_FUNS-"+obj.ITEM_CODE+"_div' class='inner' style='width:100%;max-width:1400px;'>");
		  //左侧模块区域
		  ...
		  //右侧功能区域
		  var rightDiv = $('<div class="blank fl wp">').css({"float":"left","width":"98%","clear":"none","border-left":"none"});
...
//		  var right = $("<span class='right form__right70'>").append(rightDiv1).append(rightDiv);
		  var right = $("<span class='right form__right70'>").append(rightDiv);
...
optRender = function(code,rightDiv) {
	...
	var rightSpan = $('<span id="TS_PVLG_ROLE_UPDATE_FUNS-'+obj.ITEM_CODE+'" class="ui-checkbox-default">');
	//功能权限主键
