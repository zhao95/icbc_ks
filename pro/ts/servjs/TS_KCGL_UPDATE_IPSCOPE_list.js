...
if (_viewer.getParHandler().getParHandler().getParHandler() != undefined
	...
	if (parparServId == "TS_KCGL_SH") {
		$("#TS_KCGL_UPDATE_IPSCOPE-add").hide();
		$("#TS_KCGL_UPDATE_IPSCOPE-impData").hide();
		$("#TS_KCGL_UPDATE_IPSCOPE-delete").hide();
		$("#TS_KCGL_UPDATE_IPSCOPE").find("a[opercode='optEditBtn']").hide();
	}
}
