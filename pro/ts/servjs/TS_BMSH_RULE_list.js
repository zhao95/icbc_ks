...
$("#TS_BMSH_RULE .rhGrid").find("tr").each(function(index, item) {
	if(index != 0){
		var dataId = item.id;		
...
function bindCard(){
	...
	jQuery("td [operCode='optSetBtn1']").unbind("click").bind("click", function(){
		...
		//设置
			...
			var temp = {"act":UIConst.ACT_CARD_MODIFY,"sId":"TS_BMSH_RULE","parHandler":_viewer,"widHeiArray":[width,height],"xyArray":[100,0]};
