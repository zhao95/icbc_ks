...
$("#TS_BM_GROUP_DEPT .rhGrid").find("tr").each(function(index, item) {
	if(index != 0){
		...
		$(item).find("td[icode='BUTTONS']").append(
				'<a class="rhGrid-td-rowBtnObj rh-icon" id="TS_BM_GROUP_DEPT-upd" actcode="upd" rowpk="'+dataId+'"><span class="rh-icon-inner-notext">编辑</span><span class="rh-icon-img btn-edit"></span></a>'+
				'<a class="rhGrid-td-rowBtnObj rh-icon" id="TS_BM_GROUP_DEPT-delete" actcode="delete" rowpk="'+dataId+'"><span class="rh-icon-inner-notext">删除</span><span class="rh-icon-img btn-delete"></span></a>'
				);
		// 为每个按钮绑定卡片
		bindCard();
	}
