...
$("#TS_JKDICT .rhGrid").find("tr").each(function(index, item) {
	if(index != 0){
		var dataId = item.id;		
...
function bindCard(){
	...
	jQuery("td [operCode='optSetBtn']").unbind("click").bind("click", function(){
		...
		var temp = {"act":UIConst.ACT_CARD_MODIFY,"sId":"TS_JKDICT","parHandler":_viewer,"widHeiArray":[width,height],"xyArray":[100,0]};
