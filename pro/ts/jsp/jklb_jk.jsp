    ...
    <div style="background-color: #fdfdfd">
        ...
        <div class="bkuan" style="">
            <table style="padding: 10px;width:100%">
                <tr>
                    <td style="width: 10%;text-align: right;">借考标题&nbsp;&nbsp;<span
                            style="color: red;font-weight: bold">*</span></td>
                    <td colspan="3">
                        <input style="width: 90%;height: 25px;" id="jktitle" value="">
                    </td>
                </tr>
                <tr>
					<td style="width: 10%;text-align: right;">借考一级分行</td>
					<td><select id="jkyiji"  style="width: 60%;height: 25px; border: 1px solid rgb(0, 0, 0); "></select></td>
					
					<!--  <td ><input style="width:95%;height: 25px;" id="jktitle" value=""></td>-->
					<td style="width: 20%;text-align:left ;" >希望借考的城市&nbsp;&nbsp;
					<input style="width: 30%;height: 25px;" id="jkcity" value=""></td>
					<%-- <select id="jkcity"  style="min-width: 208px;height: 25px; border: 1px solid rgb(0, 0, 0); "></select>--%>
				</tr>
                <tr>
                    <td style="width: 10%;text-align: right;">借考的考试&nbsp;&nbsp;</td>
                    <td colspan="3">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <table id="jkks-table" border="1" style="width: 95%;border-color: white;">
                            <thead>
                ...
                <tr>
                    ...
                    <td colspan="3"><textarea rows="3" cols="130" id="jkreason"></textarea></td>
                </tr>
                <tr>
