...
<%
    ...
    final String xmId = request.getParameter("XM_ID") != null ? request.getParameter("XM_ID") : "";
    final String userCode = request.getParameter("USER_CODE") != null ? request.getParameter("USER_CODE") : "";
%>
<html>
<head>
    <meta charset="utf-8">
    ...
    <script src="../js/pdfjs/js/pdf.js"></script>
    <script type="text/javascript">
        ...
        $.ajax({
            type: "post",
            async: false,
            data: {XM_ID: '<%=xmId%>', USER_CODE: '<%=userCode%>'},
            mimeType: 'text/plain; charset=x-user-defined',
            url: "TS_XMGL_ADMISSION_FILE.getAdmissionFileStream.do",
